...
def _trim(src: str, dst: str, seconds: float) -> str:
    ...
    Звук клипа сохраняем: Veo генерирует его вместе с картинкой, деньги за
    него уплачены, и он пригодится тем, кто захочет подмешать в ролик
    немного живой атмосферы.
    """
    subprocess.run(
